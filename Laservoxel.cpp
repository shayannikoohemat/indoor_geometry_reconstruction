...
/// export just voxel centers
LaserPoints LaserVoxel::export_voxel_centres(int min_points_in_vox)
{
    LaserPoints l;
        ...
        for (int j = 0; j < int(vox_num_Y); j++)
            ...
            for (int k = 0; k < int(vox_num_Z); k ++) {
                ...
                if (flag_Null || flag_minpoints) {
                    ...
                    int labeltag1_cnt;
                    /// key function: generate mepty space in defined neiborhood windows
